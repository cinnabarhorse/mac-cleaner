...
- Full Disk Access assistant that calls out stale or missing privacy grants.
- Multi-select cleanup with coalesced batch Trash confirmation.
- Safe Picks to select old low-risk cache, log, and Trash items in one step.
- Staleness filtering for items untouched for 30, 90, 180, or 365 days.
- Markdown and CSV scan report export.
